...
<ul>
<li>In <strong>chapter 1</strong>, I use an agent-based model to explain why demand for new products can be difficult to anticipate. I show how high <i>heterogeneity</i> and <i>interdependence</i> in customer demand lead to counterintuitive diffusion dynamics that can systematically invert estimates of new products’ market size, as derived from traditional quantitative techniques. I empirically validate the model with data on over 10,000 consumer product launches.</li>
